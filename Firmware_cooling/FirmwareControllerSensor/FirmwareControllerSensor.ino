    ...
    */
    ...
    switch (i)
    {
      case 0:
        ...
        break;
      case 1:
        filter2.AddValue(getRes5kTemperature(getOhms(Myads.getAds0(1))));
        tempsPel[i] = filter2.GetLowPass();
        break;
      case 2:
        filter3.AddValue(getRes5kTemperature(getOhms(Myads.getAds0(2))));
        tempsPel[i] = filter3.GetLowPass();
        break;
      case 3:
        filter4.AddValue(getRes5kTemperature(getOhms(Myads.getAds0(3))));
        tempsPel[i] = filter4.GetLowPass();
        break;
      case 4:
        filter5.AddValue(getRes5kTemperature(getOhms(Myads.getAds1(0))));
        tempsPel[i] = filter5.GetLowPass();
        break;
      case 5:
        filter6.AddValue(getRes5kTemperature(getOhms(Myads.getAds1(1))));
        tempsPel[i] = filter5.GetLowPass();
        break;
      case 6:
        filter5.AddValue(getRes5kTemperature(getOhms(Myads.getAds1(2))));
        tempsPel[i] = filter5.GetLowPass();
        break;
      case 7:
        filter6.AddValue(getRes5kTemperature(getOhms(Myads.getAds1(3))));
        tempsPel[i] = filter5.GetLowPass();
        break;
      case 8:
