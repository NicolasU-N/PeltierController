...
float MYADS::getAds1(uint8_t port)
{
    switch (port)
    {
    case 0:
    ...
    return (float)ads1.getConversion(); // returns int16_t value
}

float MYADS::getAds2(uint8_t port)
{
    switch (port)
    {
    case 0:
    ...
    return (float)ads2.getConversion();
}

float MYADS::getAds3(uint8_t port)
{
    switch (port)
    {
    case 0:
    ...
    return (float)ads3.getConversion(); // returns int16_t value
}
